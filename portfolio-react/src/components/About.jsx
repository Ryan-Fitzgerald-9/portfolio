...
const About = () => {
  return (
    <div className='flex flex-col md:flex-row justify-center px-[50px]'>
      <div id="home" className='mt-[10px] md:mt-[75px] mb-[50px] md:mb-[75px] pr-[50px] flex-col pt-20 pb-6'>
          ...
          <div className="flex justify-center ml-4 md:ml-16 space-x-10 hover:cursor-pointer">
                <a 
      ...
      <div className='mb-[50px] md:mt-[150px] md:ml-1'>
